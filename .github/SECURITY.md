...
prayer-time-plus is pre-1.0; fixes land on the latest `0.x` release.
...
[**Report a vulnerability**](https://github.com/abdulwahed-s/prayer-time-plus-kotlin/security/advisories/new)
